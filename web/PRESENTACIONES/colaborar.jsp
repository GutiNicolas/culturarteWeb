...
<html>
    ...
    <%  String error;
        ...
        if (error.equals("nn"))
            ...
            out.print("<body onload=\"alertar3('LA PROPUESTA NO SE ENCUENTRA EN FINANCIACION')\" style='background: url(IMAGENESDISENIO/fondo.jpg) repeat center center fixed;     background-size: cover;'>");
        else {
